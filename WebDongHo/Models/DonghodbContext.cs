...
public partial class DonghodbContext : DbContext
{
    ...
    public DonghodbContext(DbContextOptions<DonghodbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-1MSGKHP;Database=Donghodb;Trusted_Connection=True;TrustServerCertificate=true;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Blog>(entity =>
        {
            entity.HasKey(e => e.IdBlog).HasName("PK__BLOG__75519326EE18B3C0");
        ...
        {
            entity.HasKey(e => e.IdCart).HasName("PK__CART__7A1680A50A4B6D1B");
        ...
        {
            entity.HasKey(e => e.IdCd).HasName("PK__CART_DET__8B622F8F28BA56D9");
            ...
            entity.HasOne(d => d.IdCartNavigation).WithMany(p => p.CartDetails)
                ...
                .HasConstraintName("FK__CART_DETA__ID_CA__46E78A0C");

            entity.HasOne(d => d.IdProNavigation).WithMany(p => p.CartDetails)
                .HasForeignKey(d => d.IdPro)
                .HasConstraintName("FK__CART_DETA__ID_PR__47DBAE45");
        });

        modelBuilder.Entity<Catology>(entity =>
        {
            entity.HasKey(e => e.IdCat).HasName("PK__CATOLOGY__2BF8FA1C4328419B");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__MENU__4728FC6013311DA1");
        ...
        {
            entity.HasKey(e => e.IdPro).HasName("PK__PRODUCTS__20AF98FD6028295C");
            ...
            entity.HasOne(d => d.IdCatNavigation).WithMany(p => p.Products)
                ...
                .HasConstraintName("FK__PRODUCTS__ID_CAT__48CFD27E");
        });

        modelBuilder.Entity<Slider>(entity =>
        {
            entity.HasKey(e => e.IdSlide).HasName("PK__SLIDER__22D1BB10633DC0B8");
        ...
        {
            entity.HasKey(e => e.IdUsers).HasName("PK__USERS__1DDB35C3619C70CD");
